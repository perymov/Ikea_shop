...
const generateHeader = () => {
	...
	`;
	// вставляем верстку в body методом insertAdjacentHTML после начала body
	document.body.insertAdjacentHTML('afterbegin', header);
};

export default generateHeader; // экспортируем созданную верстку в главный файл index.js